...
def main() -> None:
    ...
    # Preserve the dataset-facing frame name when the image is a symlink;
    # resolving it may expose an original filename with a different convention.
    source_image = args.source_image.expanduser().absolute()
